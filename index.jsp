<%@page contentType="text/html"%> <%-- // $Id: //open/mondrian/webapp/index.jsp#15 $ // This software is subject to the terms of the Common Public License // Agreement, available at the following URL: //
http://www.opensource.org/licenses/cpl.html. // Copyright (C) 2001-2002 Kana Software, Inc. // Copyright (C) 2002-2008 Julian Hyde and others. // All Rights Reserved. // You must accept the terms of that agreement to use this software. //
// jhyde, 6 August, 2001 --%>
<html>
  <head>
    <meta
...
analyze very large datasets stored in SQL databases without writing SQL."
  ...
  <body>
    ...
    <ul>
      <li><a href="testpage.jsp?query=aeki_produk">AEKI- Product Cube</a></li>
      <li><a href="testpage.jsp?query=aeki_cabang">AEKI- Cabang Cube</a></li>
      <li><a href="testpage.jsp?query=aeki_waktu">AEKI- Time Cube</a></li>
