...
<jp:mondrianQuery id="query01" jdbcDriver="com.mysql.jdbc.Driver" jdbcUrl="jdbc:mysql://localhost/dw_aeki?user=root&password=" catalogUri="/WEB-INF/queries/AEKI_Schema1.xml">
  select {[Measures].[Total Sales], [Measures].[Unit Sales], [Measures].[Avg Sales]} on columns, {([Cabang].[All Cabang], [Cabang]. [ALL Cabang])} on rows from Sales
</jp:mondrianQuery>

<c:set var="title01" scope="session">AKEI - Cube Penjualan Berdasarkan Cabang</c:set>
